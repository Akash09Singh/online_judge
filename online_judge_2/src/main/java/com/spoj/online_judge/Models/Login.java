...
public class Login {
    ...
    public Login(int id, String token, String username, String email, String firstName, String lastName, String phone,UserService userService, UserRolesService userRolesService, RolesServiceImpl rolesServiceImpl) {
        this.id = id;
        this.token = token;
